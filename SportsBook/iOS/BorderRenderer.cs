	...
	public class BorderRenderer : VisualElementRenderer<csmContentView>
	{
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == VisualElement.BackgroundColorProperty.PropertyName ||
				e.PropertyName == csmContentView.StrokeProperty.PropertyName ||
				e.PropertyName == csmContentView.StrokeThicknessProperty.PropertyName ||
				e.PropertyName == csmContentView.CornerRadiusProperty.PropertyName ||
				e.PropertyName == csmContentView.WidthProperty.PropertyName ||
				e.PropertyName == csmContentView.HeightProperty.PropertyName)
			{
				this.SetupLayer();
			}
		}
