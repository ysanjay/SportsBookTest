...
extern void *mono_aot_module_SportsBook_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_SportsBook_info;
...
extern void *mono_aot_module_Xamarin_Forms_CarouselView_Platform_info;
extern void *mono_aot_module_Xamarin_Forms_CarouselView_iOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_SportsBook_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_SportsBook_info);
	...
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_CarouselView_Platform_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_CarouselView_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SportsBook.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
