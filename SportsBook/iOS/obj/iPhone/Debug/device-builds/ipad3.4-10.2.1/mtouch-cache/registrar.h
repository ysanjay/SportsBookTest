...
@class SportsBook_iOS_MyEntryRenderer;
@class Xamarin_Forms_Platform_iOS_ImageRenderer;
@class SportsBook_iOS_ImageCircleRenderer;
@class Xamarin_Forms_Platform_iOS_SwitchRenderer;
@class SportsBook_iOS_csmSwitchRendere;
@class Xamarin_Forms_Platform_iOS_ProgressBarRenderer;
@class SportsBook_iOS_CustomProgressBarRenderer1;
@class SportsBook_BorderRenderer;
